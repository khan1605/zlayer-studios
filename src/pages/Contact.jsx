...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const mailtoLink = `mailto:hello@zlayerstudios.com?subject=Quote Request from ${formData.name}&body=Name: ${formData.name}%0AEmail: ${formData.email}%0AService: ${formData.service}%0A%0A${formData.message}`;
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@zlayerstudios.com" className="text-purple-700 text-sm hover:underline">
